...
const About=()=>{
    return(
        <div className="bg-slate-800 flex justify-evenly lg:flex-row flex-col items-center py-20">
            ...
            <div>
            <h1 className='text-center font-bold text-3xl text-white pt-24 -pl-10 pr-20 font-serif'>About Me</h1>
                <p className="text-gray-400 hover:text-gray-300 text-lg font-serif pt-5 text-center lg:text-start lg:pt-auto">
                Hello, my name is <span className="font-bold text-xl text-green-400">Haileamlak Waleligne</span>  <br/>
