...
const Footers=()=>{
  return(
    <div className='bg-[#01013ae8] h-[100vh] overflow-y-hidden sm:h-[50vh] shadow-2xl font-serif text-white'>
      <div className="bg-[#01013ae8] font-serif shadow-2xl pt-10 justify-center block bottom-0 sticky pb-10">
        <div className="pt-4">
