...
const Projects = () => {
  return (
    <div
      id='projects'
      className='bg-slate-900 shadow-2xl shadow-gray-400 font-serif bg-slate-900 overflow-x-hidden'
    >
      ...
      <div className='grid  md:grid-cols-2 lg:grid-cols-3 gap-10 pt-4 justify-center md:justify-between px-4 pb-10'>
        <div
          className='hover:transform hover:translate-x-2 hover:-translate-y-2 duration-500 hover:bg-slate-600  h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black p-3'
          data-aos='slide-left'
        >
          <a href='https://65173e0d58a22723f0a471bd--deft-cuchufli-05eae1.netlify.app/'>
            <img src={book} alt='Online Book Shopping App' className='w-full h-40' />
          </a>
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/fuad-miftah/Book-Store'
          ...
          <p className='text-black text-center'>
            Full-stack project made by teams
          </p>
        </div>
        ...
        >
          ...
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/Yebetta-Code-Site-Clone-in-Next-js'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              Yenetta Code clone
            </a>
          ...
          <p className='text-black text-center'>
            Single page with Next js and Tailwindcss
          </p>
        </div>
        ...
        <div
          ...
          data-aos='slide-up'
        >
          <a href='https://hw-instagram-clone.netlify.app/'>
            {' '}
            <img src={insta} alt='Instagram clone' className='w-full h-40' />
          </a>
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/Instagram-Clone-in-React-js'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              Instagram clone
            </a>
          ...
          <p className='text-black text-center'>
            Single and best responsive page
          </p>
        </div>
        ...
        >
          ...
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/Weather-App-with-API-in-React-js'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              Weather App
            </a>
        ...
        >
          ...
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/React-Js-Note-App'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              Notebook App
            </a>
        ...
        >
          ...
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/Personal-Blog-in-React-js'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              Personal Blog
            </a>
        ...
        >
          ...
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/Random-Quote-Generator-in-React-js'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              Random Quotes
            </a>
        ...
        <div
          className='hover:transform hover:translate-x-2 hover:-translate-y-2 duration-500 hover:bg-slate-600 bg-white shadow-2xl shadow-black h-80 pt-10 rounded-lg p-3'
          data-aos='fade-down'
        >
          ...
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/Book-App-in-React-js'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              Books App
            </a>
        ...
        >
          ...
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/Budget-Tracker-App-React-js'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              Budget Tracker App
            </a>
        ...
        >
          ...
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/Recipe-App-With-API-And-With-Responsive-in-React-js'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              Food Recipe App
            </a>
        ...
        >
          ...
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/Task-Management-System-in-React-js-Node-js-Express-js-and-MYSQL'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              Task Management App
            </a>
        ...
        >
          ...
          <h1 className='text-black font-bold text-xl text-center pt-6'>
            <a
              href='https://github.com/haileamlakwalelige/CRUD-in-React-js-and-Redux'
              className='hover:border-green-500 hover:border-b-4 duration-500 ease-in-out'
            >
              CRUD App Redux
            </a>
          ...
          <p className='text-black text-center'>
            Single page with Next and Tailwindcss and Redux
          </p>
        </div>
      </div>
    </div>
