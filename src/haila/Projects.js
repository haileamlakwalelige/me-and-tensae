...
const Projects = () => {
  return (
    <div className="font-serif bg-white overflow-x-hidden">
    <h1 className="font-bold text-5xl pt-24 sm:pt-60 md:pt-32 pb-10 text-center shadow-2xl scroll-pb-10">My Projects</h1>
        <div className="grid  md:grid-cols-2 lg:grid-cols-3 gap-10 pt-4 justify-center md:justify-between px-4 pb-10">
            <div className="  h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black p-3" data-aos="slide-left">
            ...
            <div className="  h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black p-3" data-aos="slide-up">
            ...
            <div className="  h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black p-3" data-aos="slide-right">
            ...
            <div className="  h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black" data-aos="flip-right">
            ...
            <div className="  h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black" data-aos="flip-up">
            ...
            <div className="   h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black p-3" data-aos="flip-left">
            ...
            <div className="  h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black p-3" data-aos="fade-right">
            ...
            <div className=" bg-white shadow-2xl shadow-black h-80 pt-10 rounded-lg p-3" data-aos="fade-down">
            ...
            <div className=" bbg-white shadow-2xl shadow-black h-80 pt-10 rounded-lg p-3"  data-aos="fade-left">
            ...
            <div className="  h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black" data-aos="zoom-in">
            ...
            <div className="  h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black p-3" data-aos="zoom-out">
            ...
            <div className="  h-80 pt-10 rounded-lg bg-white shadow-2xl shadow-black p-3" data-aos="zoom-in">
