...
const Service=()=>{
    ...
    return(
        <div id="service" className="bg-slate-900 shadow-2xl shadow-gray-400  justify-center items-center px-10 py-32">
        <h1 className="font-bold text-5xl hover:text-blue-600 hover:text-7xl mb-10 duration-500  text-center text-gray-400">My Service</h1>
            ...
            <div className="pt-6 border-2 border-gray-400 p-3 rounded-2xl">
                <h1 className="hover:text-2xl duration-500 hover:text-blue-600 text-gray-300 font-bold text-xl  text-center">Front-end Development</h1>
                <p className="text-gray-400 duration-1000 hover:text-gray-300  text-lg  pt-10  text-start lg:pt-auto">
            ...
            <div className="pt-6 border-2 border-gray-400 p-3 rounded-2xl">
                <h1  className="hover:text-2xl duration-500 hover:text-blue-600 text-gray-300 font-bold text-xl  text-center">Back-end Development</h1>
                <p className="text-gray-400 duration-1000 hover:text-gray-300  text-lg  pt-10 text-start lg:pt-auto">
            ...
            <div className="pt-6 border-2 border-gray-400 p-3 rounded-2xl">
                <h1  className="hover:text-2xl duration-500 hover:text-blue-600 text-gray-300 font-bold text-xl  text-center">Full-Stack Development</h1>
                <p className="text-gray-400 duration-1000 hover:text-gray-300  text-lg  pt-10  text-start lg:pt-auto">
                ...
                I possess a unique set of skills that enables
                 ...
                 {full ? <button className="text-lg  text-white hover:text-gray-800 ">Read Less</button>:<button className=" hover:text-gray-800 text-lg  text-white">Read More</button>}
                 </div>
                </p>
            </div>
            <div className="pt-6 border-2 border-gray-400 p-3 rounded-2xl">
                <h1  className="hover:text-2xl duration-500 hover:text-blue-600 text-gray-300 font-bold text-xl  text-center">Mobile App Development</h1>
                <p className="text-gray-400 duration-1000 hover:text-gray-300 text-lg  pt-10  text-start lg:pt-auto">
