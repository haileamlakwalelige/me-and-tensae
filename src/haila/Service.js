...
const Service=()=>{
    ...
    return(
        <div id="service" className="bg-slate-900 shadow-2xl shadow-gray-400 font-serif justify-center items-center px-10 py-32">
        <h1 className="font-bold text-5xl hover:text-blue-600 hover:text-7xl mb-10 duration-500 font-serif text-center text-gray-400">My Service</h1>
            ...
            <div className="pt-6 border-2 border-gray-400 p-3 rounded-2xl">
                ...
                <p className="text-gray-400 duration-1000 hover:text-gray-300  text-lg font-serif pt-10  text-start lg:pt-auto">
