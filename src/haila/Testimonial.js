...
const Testimonial=()=>{
    return(
        <div className="bg-slate-900 shadow-2xl shadow-gray-400 flex flex-col text-white -center  justify-center items-center">
            <h1 className="font-bold text-center justify-center pt-10 text-3xl text items-center flex ">Here it from My Boss and My Friends</h1>
            <div className="bg-slate-900px-10 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 pt-10 pb-32 text-gray-300 gap-10 justify-center items-center">
            <div  className=' py-2 sm:h-96 hover:transform hover:translate-x-2 duration-500 hover:-translate-y-2 font-bold flex flex-col justify-center bg-white hover:bg-gray-400 px-10 text-gray-950 rounded items-center'>
                ...
                <h1 className='font-bold text-xl  py-3'>Ashenafi Belete</h1>
            ...
            <img src={abi} alt="Testimonial one" width={100} height={100} className="flex justify-center items-center rounded-full" />
                ...
                <h1 className='font-bold text-xl  py-3'>Abinet Erbaye</h1>
            ...
            <img src={getu} alt="Testimonial one" width={100} height={100} className="flex justify-center items-center rounded-full" />
                <h1 className='font-bold text-xl  py-3'>Getu Girma</h1>
                <p className="font-light ">
            ...
            <img src={getnet} alt="Testimonial one" width={100} height={100} className="flex justify-center items-center rounded-full" />
                <h1 className='font-bold text-xl  py-3'>Getnet Bante</h1>
                <p className="font-light ">
