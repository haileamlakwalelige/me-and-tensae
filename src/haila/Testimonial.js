...
const Testimonial=()=>{
    return(
        <div className="bg-[#0e0e2b] flex flex-col text-white -center  justify-center items-center">
            ...
            <div  className='h-[900px] sm:h-96 hover:transform hover:translate-x-2 duration-500 hover:-translate-y-2 font-bold flex flex-col justify-center bg-white hover:bg-gray-400 px-10 py-16 text-gray-950 rounded items-center'>
